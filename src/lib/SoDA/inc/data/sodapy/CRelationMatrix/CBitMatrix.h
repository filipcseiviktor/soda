...
public:
     ...
     */
    CBitMatrix(IndexType row, IndexType col); //getNumOfCols()-->CBitMatrix.h

    /**
     * @brief Destroys a CBitMatrix object.
     */
    ~CBitMatrix(); //getNumOfCols()-->CBitMatrix.h

    /**
     * @brief Returns the number of rows of the matrix.
     * @return Number of rows of the matrix.
     */
    IndexType getNumOfRows() const; //cpp-hez kell

    /**
     * @brief Returns the number of columns of the matrix.
     * @return Number of columns of the matrix.
     */
    IndexType getNumOfCols() const; //cpp-hez kell
     ...
     */
    bool get(IndexType row, IndexType col) const; //cpp-hez kell
