...
void CIDManager::remove(const IndexType id)//remove() --IIDManager.h is kell
{
...
void CIDManager::remove(const String& value) //remove() --IIDManager.h is kell
{
...
void CIDManager::clear() //clear() --IIDManager.h is kell
{
    m_data.clear();
    m_adat.clear();
}
