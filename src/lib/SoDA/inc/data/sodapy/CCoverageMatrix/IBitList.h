...
//#include "CBitWriter.h" ennél alapból ott volt  a sodalibdefs
...
public:
     ...
     */
    virtual ~IBitList() {} //CCoverageMatrix.cpp-hez kell
     ...
     */
    virtual void push_back(bool value) = 0;  //CCoverageMatrix.cpp-hez kell
