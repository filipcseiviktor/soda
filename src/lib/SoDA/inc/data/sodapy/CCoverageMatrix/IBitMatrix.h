...
public:
     ...
     */
    virtual ~IBitMatrix() {} //CCoverageMatrix.cpp-hez kell

    /**
     * @brief Returns the number of rows of the matrix.
     * @return Number of rows of the matrix.
     */
    virtual IndexType getNumOfRows() const = 0; //CCoverageMatrix.cpp-hez kell

    /**
     * @brief Returns the number of columns of the matrix.
     * @return Number of columns of the matrix.
     */
    virtual IndexType getNumOfCols() const = 0; //CCoverageMatrix.cpp-hez kell
/**
     ...
     */
    virtual bool get(IndexType row, IndexType col) const = 0; //CCoverageMatrix.cpp-hez kell
     ...
     */
    virtual void set(IndexType row, IndexType col, bool value) = 0; //CCoverageMatrix.cpp-hez kell
     ...
     */
    virtual void resize(IndexType newRow, IndexType newCol) = 0; //CCoverageMatrix.cpp-hez kell
