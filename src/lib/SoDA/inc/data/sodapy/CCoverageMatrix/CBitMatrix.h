...
public:
     ...
     */
    CBitMatrix(); //CPP-ben:  m_data(new CBitMatrix()) miatt kell
     ...
     */
    CBitMatrix(IndexType row, IndexType col); //CPP-ben:  m_data(new CBitMatrix()) miatt kell
   ...
   */
    IndexType getNumOfCols() const;
        ...
        //Ezek Mégis kellenek, az IBITMATRIX-ból öröklődik/////////////////////////////////////////////////////
      /**
...
private:
   /* class MatrixIterator;
     ...
     * @brief NIY Copy constructor.
      */
    CBitMatrix(const CBitMatrix&); //CPP-ben:  m_data(new CBitMatrix()) miatt kell

    /**
     * @brief NIY operator =.
     * @return Reference to a CBitMatrix object.
     */
    CBitMatrix& operator=(const CBitMatrix&); //CPP-ben:  m_data(new CBitMatrix()) miatt kell
