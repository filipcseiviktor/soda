...
//#include "CSoDAio.h"itt nem volt alapból ott a sodalib
...
public:
     ...
     */
    virtual ~IIDManager() {} //CCoverageMatrix.cpp-hez kell
     ...
     */
    virtual bool containsValue(const String&) const = 0; //CCoverageMatrix.cpp-hez kell
    ...
    virtual IntVector getIDList() const = 0; //CCoverageMatrix.cpp-hez kell
 /**
     * @brief Returns the number of elements in the manager.
     * @return The number of elements in the manager.
     */

    virtual IndexType size() const = 0; //CCoverageMatrix.cpp-hez kell

    /**
     * @brief Adds a value with the specified id.
     */

    virtual void add(const IndexType, const String&) = 0; //CCoverageMatrix.cpp-hez kell
