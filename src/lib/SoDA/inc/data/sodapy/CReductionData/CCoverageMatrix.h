...
/**
 ...
 /**
     ...
     */
    virtual void setRelation(const IndexType testcaseIdx, const IndexType codeElementIdx, const bool isCovered=true);  //cpp-hez kell

    
    /**
     * @brief Resizes the coverage matrix if the IIDManagers have different sizes.
     */
    virtual void refitMatrixSize();  //cpp-hez kell
     ...
     *                    Use refitMatrixSize()!
     */
    virtual void addTestcaseName(const String&);  //cpp-hez kell
////////////////////////////////////////////////////////////////////////////////////////////////////
