...
public:
  ...
  /**
     ...
     */
    virtual IBitMatrixIterator& begin() = 0;  //cpp-hez kell
     ...
     */
    virtual IBitMatrixIterator& end() = 0; //cpp-hez kell



virtual void save(io::CBinaryIO* out, const io::CSoDAio::ChunkID chunk = io::CSoDAio::BITMATRIX) const  //cpp-hez kell
    {
