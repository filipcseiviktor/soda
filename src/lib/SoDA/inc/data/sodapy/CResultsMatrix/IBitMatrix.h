...
//#include "IBitList.h"   ezek elvileg nem kellenek
...
public:
     ...
     */
    virtual IndexType getNumOfRows() const = 0;  //cpp-hez kell

    /**
     * @brief Returns the number of columns of the matrix.
     * @return Number of columns of the matrix.
     */
    virtual IndexType getNumOfCols() const = 0; //cpp-hez kell
     ...
     */
    virtual void set(IndexType row, IndexType col, bool value) = 0; //cpp-hez kell
   ...
   /**
     ...
     */
    virtual void resize(IndexType newRow, IndexType newCol) = 0; //cpp-hez kell

    /**
     * @brief Set the object's attributes to default value.
     */
    virtual void clear() = 0; //cpp-hez kell
