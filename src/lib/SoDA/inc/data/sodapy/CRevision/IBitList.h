...
public:
     ...
     */
    virtual bool at(IndexType index) const = 0;  //cpp-hez kell

    /**
     * @brief Adds a new element at the end of the vector.
     * @param value  Value to be stored at the new element.
     */
    virtual void push_back(bool value) = 0; //cpp-hez kell
 ...
 /**
     ...
     */
    virtual void erase(IndexType index) = 0; //cpp-hez kell
  ...
  /**
     ...
     */
    virtual IBitListIterator& begin() = 0; //cpp-hez kell
     ...
     */
    virtual IBitListIterator& end() = 0; //cpp-hez kell
