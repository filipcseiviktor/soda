...
public:
  ...
  /**
     ...
     */
    void writeInt4(int i); //cpp-hez kell
     ...
     * @throw IOExceotion if the open mode isn't write.
     */
    void writeUInt4(unsigned i); //cpp-hez kell
     ...
     */ 
    unsigned readUInt4(); //cpp-hez kell
     ...
     * @throw IOExceotion if the open mode isn't write.
     */
    void writeULongLong8(unsigned long long i); //cpp-hez kell
 ...
 /**
     ...
     * @throw IOExceotion if the open mode isn't read.
     */
    const String readString();  //cpp-hez kell
     ...
     * @throw IOExceotion if the open mode isn't write.
     */ 
    void writeString(const String& s);  //cpp-hez kell
    /**
     ...
     * @throw IOExceotion if the open mode isn't write.
     */
    void writeData(const void* data, std::streamsize size); //cpp-hez kell
     ...
     * @throw IOExceotion if the open mode isn't read.
     */
    void readData (void* data, std::streamsize size); //cpp-hez kell
