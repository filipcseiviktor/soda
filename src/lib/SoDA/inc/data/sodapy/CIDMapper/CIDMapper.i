...
#include "CIDMapper.h"  //containsValue(),getID(),getValue(),clear()
#include "CBinaryIO.h"
#include "SoDALibDefs.h"  
#include "CSoDAio.h" 
#include "IIDManager.h"  //containsValue(),getID(),getValue(),getIDList(),clear()
%}
...
/*CSoDAio */ 
	...
	/* a cel, hogy a python oldalon a modul importalasa utan pl. ne "cidmapper.RELATION" -kent kelljen hivatkozzunk, hanem lehessen a kovetkezokepp:
