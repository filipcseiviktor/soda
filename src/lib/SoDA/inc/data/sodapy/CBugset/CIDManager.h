...
public:
     ...
     */
    virtual IndexType getID(const String&) const;   //cpp-hez kell
     ...
     */
    virtual String getValue(const IndexType) const; //cpp-hez kell
     ...
     */
    virtual StringVector getValueList() const; //cpp-hez kell


    /**
     * @brief Adds a value to the manager as the last element.
     */
    virtual void add(const String&); //cpp-hez kell

    /**
     * @brief Removes an element by its id.
     */
    virtual void remove(const IndexType);//cpp-hez kell

    /**
     * @brief Removes an element by its value.
     */
    virtual void remove(const String&); //cpp-hez kell
  ...
  /**
     ...
     */
    virtual void add(const IndexType, const String&); //cpp-hez kell
