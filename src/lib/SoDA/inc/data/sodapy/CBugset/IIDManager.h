...
public:
     ...
     */
    virtual bool containsValue(const String&) const = 0;  //cpp-hez kell
     ...
     */
    virtual IndexType getID(const String&) const = 0;  //cpp-hez kell
