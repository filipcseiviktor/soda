...
//a CCoverageMatrix-hoz tartozó összes header fájlból az összes operator overloading kigyűjtve, Python másképp kezeli
...
// __eq__  operator=  // __getitem__ operator[]  __ne__ operator!=
